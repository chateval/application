# Generated by Django 2.0.6 on 2018-06-27 16:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Baseline',
            fields=[
                ('model', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='core.Model')),
                ('evaluationdataset', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.EvaluationDataset')),
            ],
            options={
                'db_table': 'Baseline',
