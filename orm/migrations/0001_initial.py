# Generated by Django 2.0.7 on 2018-09-03 01:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mturk_run_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='orm.HumanEvaluations')),
                ('prompt', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='orm.EvaluationDatasetText')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='orm.Author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='orm.Model')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='baselines',
            field=models.ManyToManyField(to='orm.Model'),
        ),
        migrations.AddField(
