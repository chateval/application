...
from eval.views import uploads, submit, delete, publish, human, login_view, signup_view, compare, dbdc5download, dbdc5submit, dstc10submit
...
urlpatterns = [
    ...
    path('dstc10_data/', dbdc5download, name='dstc10download'),
    ## SITE ROUTES
