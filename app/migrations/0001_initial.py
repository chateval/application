# Generated by Django 2.0.6 on 2018-06-14 19:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('evaluationdataset', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='app.EvaluationDataset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluationdataset', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='evaluationdatasets', to='app.EvaluationDatasetText')),
                ('prompt', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.EvaluationDatasetText')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='automaticevaluation',
            name='metric',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.Metric'),
        ),
        migrations.AlterUniqueTogether(
            name='modelresponse',
